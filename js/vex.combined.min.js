      ...
      a("classlist-polyfill"), a("es6-object-assign").polyfill();var d = a("domify"),
        ...
        var a = document.createElement("div"),
          ...
          var b = function b(a) {
            ...
            function a(a) {
            ...
            }.bind(this);return g && e ? (this.rootEl.addEventListener(g, f), this.overlayEl.addEventListener(g, f), this.rootEl.classList.add(h.closing), this.overlayEl.classList.add(h.closing)) : f(), !0;
              ...
              o = c.rootEl = document.createElement("div");o.classList.add(h.vex), f(o, m.className);var p = c.overlayEl = document.createElement("div");p.classList.add(h.overlay), f(p, m.overlayClassName), m.overlayClosesOnClick && o.addEventListener("click", function (a) {
            a.target === o && c.close();
          }), n.appendChild(p);var q = c.contentEl = document.createElement("div");if (q.classList.add(h.content), f(q, m.contentClassName), q.appendChild(m.content instanceof window.Node ? m.content : d(m.content)), o.appendChild(q), m.showCloseButton) {
            var r = c.closeEl = document.createElement("div");r.classList.add(h.close), f(r, m.closeClassName), r.addEventListener("click", c.close.bind(c)), q.appendChild(r);
